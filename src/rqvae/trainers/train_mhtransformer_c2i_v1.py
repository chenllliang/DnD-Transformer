...
from rqvae.models.mhtransformer.gpt_multitoken import GPT_models
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num-pred-heads", type=int, default=1)
    parser.add_argument("--class-dropout-prob", type=float, default=0.1)
    parser.add_argument("--uncond", action='store_true')
    parser.add_argument("--train-code-depth", type=int, default=1) 
